...
final class DB
{
	...
	{
		return "data/texture/\xc0\xaf\xc0\xfa\xc0\xce\xc5\xcd\xc6\xe4\xc0\xcc\xbd\xba/item/{$file_name}";
	}
	
	// Item Collection path
	static public function get_item_collection_path($file_name)
	{
		return "data/texture/\xc0\xaf\xc0\xfa\xc0\xce\xc5\xcd\xc6\xe4\xc0\xcc\xbd\xba/collection/{$file_name}";
	}
