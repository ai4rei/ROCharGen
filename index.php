...
if($settings['use_iteminfo_lua'])
	define('USE_ITEMINFO_LUA', TRUE);
else
	define('USE_ITEMINFO_LUA', FALSE);
...
Cache::$time          =     0              ;   // cache for 15 mins (set to 0 if you want to disable cache).
//- Client
...
//- Sql
Controller::$hostname =     $settings['db_host']          ;   // Mysql Host
Controller::$database =     $settings['db_name']           ;   // Database Name
Controller::$username =     $settings['db_user']           ;   // Database Username
Controller::$password =     $settings['db_pass']           ;   // Database Pass
/// -----------------------------------------------------------------
